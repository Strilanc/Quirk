export default class FragmentShaders {
}
 ...
 */
FragmentShaders.APPLY_CUSTOM_QUBIT_OPERATION = `
    /**
 ...
 */
FragmentShaders.INIT_SINGLE_CONTROL = `
    /**
     * The width and height of the textures being operated on.
     */
    uniform vec2 textureSize;
 ...
 */
FragmentShaders.PACK_COMPONENT_FLOAT_INTO_BYTES = `
    uniform vec2 textureSize;
 ...
 */
FragmentShaders.COMBINE_CONTROLS = `
    /**
     * The width and height of the textures being operated on.
     */
    uniform vec2 textureSize;
 ...
 */
FragmentShaders.FROM_AMPLITUDES_TO_PROBABILITIES = `
    uniform vec2 textureSize;",
    uniform sampler2D inputTexture;",
 ...
 */
FragmentShaders.CONDITIONAL_PROBABILITIES_PIPELINE = `
    uniform vec2 textureSize;
    uniform sampler2D inputTexture;
