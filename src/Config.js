...
Config.PROBABILITY_BOX_BACK_FILL_COLOR = "#EFD";
Config.PROBABILITY_BOX_FILL_UP_COLOR = "#4F4";
Config.PAINT_MATRIX_GRID_COLOR_OR_NULL = null;

Config.SIMPLE_GATE_HIGHLIGHT = '#FF8';
...
Config.MAX_LIVE_UPDATE_WIRE_COUNT = 10;
